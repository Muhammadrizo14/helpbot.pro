      ...
      <form @submit.prevent="submit" class="register__form">
        ...
        >
          ...
          <InputText
            ...
            :invalid="v$.surname.$errors.length > 0"
            id="surname"
        ...
        <div
          class="flex flex-column gap-2 pb-4 w-full"
        ...
        <div class="flex flex-column gap-3 pb-4">
          <div class="flex align-items-center">
            ...
            <label for="ingredient1" class="ml-2"
              >Согласен(-на) на рассылку рекламных материалов</label
            >
          </div>
        ...
        <Button
          type="submit"
          severity="submit"
          class="flex justify-content-center w-full p-3 mb-4"
        >
